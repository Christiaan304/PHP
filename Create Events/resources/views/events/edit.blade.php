            ...
            <form action="{{ route('event.update', $event) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label for="event_start_date" class="form-label"><i class="fa-regular fa-calendar-days"></i> Data de
                                início</label>
                        ...
                        <div class="col-md-3">
                            <label for="event_end_date" class="form-label"><i class="fa-regular fa-calendar-days"></i> Data do
                                término</label>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <label for="event_location" class="form-label"><i class="fa-solid fa-location-dot"></i> Local do
                                evento</label>
                        ...
                        <div class="col-md-4">
                            <label for="event_image" class="form-label"><i class="fa-regular fa-image fa-lg"></i> Imagem do
                                evento</label>
        
                            <input class="form-control" type="file" name="event_image" id="event_image">
                            <div class="form-text">Tamanho e largura mínimo: 200 px - Tipos permitidos: jpg, jpeg e png</div>
                            <img src="/events/images/{{ $event->image }}" class="img-fluid img-preview" alt="{{ $event->image }}">
                        </div>
        
                        <div class="col-md-2">
                            <label for="event_private" class="form-label"><i class="fa-solid fa-lock"></i> Evento
                                privado?</label>
                            <select name="event_private" id="event_private" class="form-control" value="{{ $event->private }}"
                                required>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <label for="event_description" class="form-label"><i class="fa-regular fa-comment"></i> Descrição do
                                evento</label>
                            <textarea class="form-control" name="event_description" id="event_description" rows="3" required>{{ $event->description }}</textarea>
                        </div>
                    </div>
        
                    <div class="row mt-3">
                        <label for="" class="form-label"><i class="fa-solid fa-utensils fa-lg"></i> Adicione itens de
                            infraestrutura</label>
        
                        <div class="col-md-6">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="cadeira" name="items[]"
                                    value="Cadeira">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="palco" name="items[]"
                                    value="Palco">
                        ...
                        <div class="col-md-6">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="open_food"><i class="fa-solid fa-pizza-slice"></i> Open
                                    Food</label>
                            </div>
                    ...
                    <button type="submit" class="btn btn-primary mt-3">Atualizar evento</button>
